...
RSpec.describe Purchase, :type => :model do
  ...
  it 'generates an access token before saving' do
    # Stub Time.now since it's used to generate the idempotency key @time_now = Time.parse("Apr 28 2016")
  ...
  describe '#confirm!' do
    ...
    it 'saves the charger_id' do
      expect(saved_purchase.charger_id).to eq '123'
    end
